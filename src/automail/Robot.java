...
public class Robot {
    ...
    private AbstractMailItem deliveryItem = null;
    private AbstractMailItem tube = null;
	...
	public AbstractMailItem getTube() {
		return tube;
	}
	...
	public void addToHand(AbstractMailItem mailItem) throws ItemTooHeavyException {
		assert(deliveryItem == null);
		deliveryItem = mailItem;
		if (deliveryItem.weight > INDIVIDUAL_MAX_WEIGHT) throw new ItemTooHeavyException();
	}

	public void addToTube(AbstractMailItem mailItem) throws ItemTooHeavyException {
		assert(tube == null);
		tube = mailItem;
