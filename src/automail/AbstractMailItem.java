...
/**
 * @program: Automail
 * @description: Refactor the original MailItem class to an abstraction for all MailItems(and also future extensions)
 * @author: Pinzhuo Zhao, StudentID:1043915
 * @create: 2021-04-05 22:55
 **/
public abstract class AbstractMailItem {
    ...
    public AbstractMailItem(int dest_floor, int arrival_time, int weight){
